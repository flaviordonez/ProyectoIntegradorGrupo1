...
Personas::Personas(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Connect(wxID_ANY,wxEVT_CLOSE_WINDOW,(wxObjectEventFunction)&Personas::OnClose);
	//*)
...
void Personas::OnbGuardarClick(wxCommandEvent& event)
{
    ...
    //compo->cerrar();//ESTA LINEA HACE QUE SE CIERRE LA APLICACION
...
void Personas::OnbEliminarClick(wxCommandEvent& event)
{
    ...
    //compo->cerrar();//eSTA LINEA HACÍA QUE SE CIERRE LA APLICACION
    limpia();
